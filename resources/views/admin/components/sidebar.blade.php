...
<aside class="app-sidebar">
    <div class="sidebar-img">
        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="{{ route('admin.branches.index') }}" class="side-menu__item {{ request()->routeIs('admin.branches.index') ? 'active' : '' }}">
                    <i class="side-menu__icon fe fe-edit"></i>
                    <span class="side-menu__label">Branches and Province</span>
                </a>
            </li>
